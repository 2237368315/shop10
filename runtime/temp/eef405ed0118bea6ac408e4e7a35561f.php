<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:62:"D:\WWW\shop10\public/../application/back\view\brand\index.html";i:1541646211;s:64:"D:\WWW\shop10\public/../application/back\view\common\layout.html";i:1511170805;s:64:"D:\WWW\shop10\public/../application/back\view\common\header.html";i:1511170604;s:61:"D:\WWW\shop10\public/../application/back\view\common\nav.html";i:1511170654;s:64:"D:\WWW\shop10\public/../application/back\view\common\footer.html";i:1511170470;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <a href="<?php echo url('set'); ?>" data-toggle="tooltip" title="新增" class="btn btn-primary  <?php if(!checkPriv('brand-create')): ?>disabled<?php endif; ?>"> <i class="fa fa-plus"></i>
                </a>
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="<?php echo url('index'); ?>">品牌管理</a>
                </li>
            </ul>
        </div>
    </div>
    <div class="container-fluid">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="filter_title" value="<?php echo (isset($filter['filter_title']) && ($filter['filter_title'] !== '')?$filter['filter_title']:''); ?>" placeholder="品牌" id="input-filter-title" class="form-control" />
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="control-label" for="input-filter_site">官网</label>
                                <input type="text" name="filter_site" value="<?php echo (isset($filter['filter_site']) && ($filter['filter_site'] !== '')?$filter['filter_site']:''); ?>" placeholder="官网" id="input-filter_site" class="form-control" />
                            </div>
                        </div>
                    </div>
                ...
                <form action="<?php echo url('multi'); ?>" method="post" enctype="multipart/form-data" id="form-index">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td class="text-left">
                                    <a href="<?php echo urlOrder('index', $filter, $order, 'title'); ?>" class="<?php echo classOrder($order, 'title'); ?>">品牌</a>
                                </td>
                                <td class="text-left">
                                    <a href="<?php echo urlOrder('index', $filter, $order, 'site'); ?>" class="<?php echo classOrder($order, 'site'); ?>">官网</a>
                                </td>
                                <td class="text-right">
                            ...
                            <?php if($paginator->total() > 0): foreach($paginator as $row): ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <img src="/upload/brand/<?php echo $row['logo']; ?>" alt="Logo" class="img-thumbnail" style="max-width: 40px"/>
                                    </td>

                                    <td class="text-left"><?php echo $row['title']; ?></td>
                                    <td class="text-left"><?php echo $row['site']; ?></td>
                                    <td class="text-right"><?php echo $row['sort']; ?></td>
                                    <td class="text-right">
                                        <a href="<?php echo url('set', ['id'=>$row['id']]); ?>" data-toggle="tooltip" title="编辑" class="btn btn-primary <?php if(!checkPriv('brand-edit')): ?>disabled<?php endif; ?>">
