<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"D:\WWW\shop10\public/../application/back\view\admin\login.html";i:1541818659;}*/ ?>
<!DOCTYPE html>
...
<div id="container">
    <header id="header" class="navbar navbar-static-top">
        <div class="navbar-header">
            <a href="" class="navbar-brand"><img src="__STATIC__/back/image/logo.png" alt="BuyPlus" title="BuyPlus" /></a></div>
    </header>
    <div id="content">
                            ...
                            <form action="<?php echo url('login'); ?>" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group"><span class="input-group-addon"><i class="fa fa-lock"></i></span>
                                        ...
                                        <img src="<?php echo captcha_src(); ?>"  onclick="this.src='<?php echo captcha_src(); ?>?'+Math.random();" width="120" style=cursor:pointer;" alt="captcha" />
                                        </div>
