    ...
    <div class="page-header">
        <div class="container-fluid">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="<?php echo url('index'); ?>">角色管理</a>
                </li>
            </ul>
        </div>
    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="filter_title" value="<?php echo (isset($filter['filter_title']) && ($filter['filter_title'] !== '')?$filter['filter_title']:''); ?>" placeholder="角色" id="input-filter_title" class="form-control" />
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label class="control-label" for="input-filter_description">描述</label>
                                    <input type="text" name="filter_description" value="<?php echo (isset($filter['filter_description']) && ($filter['filter_description'] !== '')?$filter['filter_description']:''); ?>" placeholder="描述" id="input-filter_description" class="form-control" />
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label class="control-label" for="input-filter_is_super">是否为超管</label>
                                    <input type="text" name="filter_is_super" value="<?php echo (isset($filter['filter_is_super']) && ($filter['filter_is_super'] !== '')?$filter['filter_is_super']:''); ?>" placeholder="是否为超管" id="input-filter_is_super" class="form-control" />
                                </div>
                            </div>
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo urlOrder('index', $filter, $order, 'title'); ?>" class="<?php echo classOrder($order, 'title'); ?>">角色</a>
                                </td>
                                <td class="text-center">
                                    <a href="<?php echo urlOrder('index', $filter, $order, 'description'); ?>" class="<?php echo classOrder($order, 'description'); ?>">描述</a>
                                </td>
                                <td class="text-center">
                                    <a href="<?php echo urlOrder('index', $filter, $order, 'is_super'); ?>" class="<?php echo classOrder($order, 'is_super'); ?>">是否为超管</a>
                                </td>
                                <td class="text-center">
                            ...
                            <tr>
                                ...
                                <td class="text-left"><?php echo $row['is_super']; ?></td>
                                ...
                                <td class="text-right">
                                    ...
                                    <a href="<?php echo url('setAction', ['id'=>$row['id']]); ?>" data-toggle="tooltip" title="授权" class="btn btn-success <?php if('1'==$row['is_super']): ?>disabled<?php endif; ?>">
                                        <i class="fa fa-key"></i>
                                    </a>
                                </td>
                            </tr>
