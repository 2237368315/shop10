<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:68:"D:\WWW\shop10\public/../application/back\view\admin\setpassword.html";i:1511170606;s:64:"D:\WWW\shop10\public/../application/back\view\common\layout.html";i:1511170805;s:64:"D:\WWW\shop10\public/../application/back\view\common\header.html";i:1511170604;s:61:"D:\WWW\shop10\public/../application/back\view\common\nav.html";i:1511170654;s:64:"D:\WWW\shop10\public/../application/back\view\common\footer.html";i:1511170470;}*/ ?>
<!DOCTYPE html>
...
<div id="content">
    ...
    <div class="page-header">
        <div class="container-fluid">
            ...
            <h1>管理员[<?php echo $admin->username; ?>]修改密码</h1>
            <ul class="breadcrumb">
                <li>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">
                    ...
                    管理员[<?php echo $admin->username; ?>]修改密码
                </h3>
            </div>
            <div class="panel-body">
                <form action="<?php echo url('setPassword', ['id'=>$id]); ?>" method="post" id="form-set" class="form-horizontal">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab-general">
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-sm-10">
                                    <input type="password" name="password" value="" placeholder="新密码" id="input-password" class="form-control" />
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-sm-10">
                                    <input type="password" name="password_confirm" value="" placeholder="确认密码" id="input-password_confirm" class="form-control" />
