...
interface RequestFactoryInterface
{
     ...
     *            username in site [0], the password in site [2], and can optionally contain the authentication type
     *            in site [3]. The authentication types are: "Basic", "Digest", "NTLM", "Any" (defaults to "Basic").
