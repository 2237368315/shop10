...
class MemberController extends Controller
{
    ...
    public function loginAction(Request $request)
    {
        ...
        elseif ($request->isPost()) {
            ...
            ($member=httpRequest([
                'type' => 'get',
                'url' => 'http://shop10.cn/member-info.html',
                'data' => [
                    'type' => 'telephone',
                    'value' => input('account'),
                ],
    ...
    public function checkoutAction()
    {
        ...
        $shipping_list = httpRequest([
            'type' => 'get',
            'url' => 'http://shop10.cn/shippings.html',
            'data' => [
                'type' => 'enabled',
            ],
            'dataType' => 'json',
...
//        }
    ...
    public function addressAddAction()
    {
        ...
        $resp = httpRequest([
           'type' => 'post',
           'url' => 'http://shop10.cn/address-add.html',
           'data' => $data,
           'dataType' => 'json',
        ]);
        ...
        if (false == $resp['error']) {
            ...
            httpRequest([
                'type' => 'post',
                'url' => 'http://shop10.cn/address-set-default.html',
                'data' => [
...
//                'dataType' => 'json',
    ...
    public function addressListAction()
    {
        ...
        $resp = httpRequest([
            'type' => 'get',
            'url' => 'http://shop10.cn/addresses.html',
            'data' => [
                'type' => 'member',
